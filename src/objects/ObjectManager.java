...
public class ObjectManager {
    ...
    public void drawBackgroundTrees(Graphics g, int xLvlOffset) {
        for (BackgroundTree bt : currentLevel.getTrees()) {
            ...
            if (type == 9)
                type = 8;
            g.drawImage(treeImgs[type - 7][bt.getAnimationIndex()], bt.getX() - xLvlOffset + GetTreeOffsetX(bt.getType()), (int) (bt.getY() + GetTreeOffsetY(bt.getType())), GetTreeWidth(bt.getType()),
